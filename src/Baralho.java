...
public class Baralho {
    ...
    private void inicializarBaralho() {
        ...
        compra.add(new CartaDano("Esqueceu a senha do GOV", "Faz o inimigo perder tempo recuperando a senha", 2, 45));
        compra.add(new CartaDano("Chuva no Litoral", "Atrapalha todos os planos e deixa tudo um caos", 4, 30));
        ...
        compra.add(new CartaDano("Internet Caiu", "Interrompe tudo no pior momento possível", 2, 25));
