...
public class NoMapaTest {
    ...
    public void testCriacaoECaminhosDoMapa() {
        ...
        Batalha batalha = new Batalha("Batalha de Teste", silvio, inimigos, baralho, "arte_silvio", "arte_cartao", "arte_boleto");
        ...
        assertEquals(batalha, inicio.getEvento(), "A batalha associada deve ser a mesma que passámos no construtor");
